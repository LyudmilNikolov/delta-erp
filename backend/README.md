...
- `DELIA_ERP_DATA_DIR`: optional base directory for generated files. The packaged Windows app defaults to `%LOCALAPPDATA%\DeliaERP`.
- `DELIA_ERP_WEB_DIR`: optional path to a compiled Angular browser directory.
